...
<title>AgentContract Report — ${escapeHtml(OVERALL_STATUS_LABELS[report.overallStatus])}</title>
<style>
...
<footer>Generated by AgentContract.</footer>
</main>
</body>
</html>
`;
